...
def scrape_velez_stats():
    """Scrapea las estadísticas de Vélez Sarsfield"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10079/stats/velez-sarsfield/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Vélez Sarsfield...")
    stats_data = scrape_velez_stats()
