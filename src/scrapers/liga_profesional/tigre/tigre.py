...
def scrap_plantel_tigre():
    """Función principal para scrapear el plantel de tigre"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de tigre")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/89396/squad/tigre")
