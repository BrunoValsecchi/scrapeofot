...
def scrape_tigre_stats():
    """Scrapea las estadísticas de Tigre"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/89396/stats/tigre/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Tigre...")
    stats_data = scrape_tigre_stats()
