...
def scrape_instituto_stats():
    """Scrapea las estadísticas de Instituto"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10090/stats/instituto/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Instituto...")
    stats_data = scrape_instituto_stats()
