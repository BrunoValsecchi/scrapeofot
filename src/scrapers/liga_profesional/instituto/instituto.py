    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Instituto', 'Instituto', 'Liga Profesional'))
...
def scrap_plantel_instituto():
    """Función principal para scrapear el plantel de instituto"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de instituto")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10090/squad/instituto")
