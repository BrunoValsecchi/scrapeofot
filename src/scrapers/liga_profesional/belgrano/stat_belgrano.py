...
def scrape_belgrano_stats():
    """Scrapea las estadísticas de Belgrano"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10092/stats/belgrano/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Belgrano...")
    stats_data = scrape_belgrano_stats()
