    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Belgrano', 'Belgrano', 'Liga Profesional'))
...
def scrap_plantel_belgrano():
    """Función principal para scrapear el plantel de belgrano"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de belgrano")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10092/squad/belgrano")
