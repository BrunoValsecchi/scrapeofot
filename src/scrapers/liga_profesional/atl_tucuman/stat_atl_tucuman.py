...
def scrape_atl_tucuman_stats():
    """Scrapea las estadísticas de Atlético Tucumán"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/161727/stats/atletico-tucuman/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Atlético Tucumán...")
    stats_data = scrape_atl_tucuman_stats()
