    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Atletico Tucuman', 'Atletico Tucuman', 'Liga Profesional'))
...
def scrap_plantel_atltucuman():
    """Función principal para scrapear el plantel de atltucuman"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de atltucuman")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/161727/squad/atletico-tucuman")
