...
def scrape_estudiantes_stats():
    """Scrapea las estadísticas de Estudiantes"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10094/stats/estudiantes/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Estudiantes...")
    stats_data = scrape_estudiantes_stats()
