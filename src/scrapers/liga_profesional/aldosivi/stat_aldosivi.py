...
def scrape_aldosivi_stats():
    """Scrapea las estadísticas de aldosivi """
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/161728/stats/aldosivi/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de aldosivi ...")
    stats_data = scrape_aldosivi_stats()
