    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Aldosivi', 'Aldosivi', 'Liga Profesional'))
...
def scrap_plantel_aldosivi():
    """Función principal para scrapear el plantel de aldosivi"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de aldosivi")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/161728/overview/aldosivi")
