...
def scrape_san_martin_stats():
    """Scrapea las estadísticas de San Martín"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/89395/stats/san-martin-san-juan/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de San Martín de Tucumán...")
    stats_data = scrape_san_martin_stats()
