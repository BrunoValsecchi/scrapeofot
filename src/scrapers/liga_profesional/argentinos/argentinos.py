    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Argentinos Juniors', 'Arg. Juniors', 'Liga Profesional'))
...
def scrap_plantel_argentinos():
    """Función principal para scrapear el plantel de Argentinos Juniors"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de Argentinos Juniors")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10086/squad/argentinos-juniors")
