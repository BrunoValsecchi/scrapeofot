...
def scrape_argentinos_stats():
    """Scrapea las estadísticas de Argentinos Juniors"""
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Argentinos Juniors...")
    stats_data = scrape_argentinos_stats()
