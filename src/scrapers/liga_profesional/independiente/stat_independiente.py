...
def scrape_independiente_stats():
    """Scrapea las estadísticas de Independiente"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10078/stats/independiente/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Independiente...")
    stats_data = scrape_independiente_stats()
