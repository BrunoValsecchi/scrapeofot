    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Independiente', 'Independiente', 'Liga Profesional'))
...
def scrap_plantel_independiente():
    """Función principal para scrapear el plantel de Independiente"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de Independiente")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10078/squad/independiente")
