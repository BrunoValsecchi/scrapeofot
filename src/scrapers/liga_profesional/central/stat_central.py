...
def scrape_central_stats():
    """Scrapea las estadísticas de Rosario Central"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10084/stats/rosario-central/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Rosario Central...")
    stats_data = scrape_central_stats()
