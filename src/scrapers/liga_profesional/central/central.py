    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Rosario Central', 'Rosario Central', 'Liga Profesional'))
...
def scrap_plantel_centra():
    """Función principal para scrapear el plantel de centra"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de centra")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10084/squad/rosario-central")
