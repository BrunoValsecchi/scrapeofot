...
def scrape_river_stats():
    """Scrapea las estadísticas de River Plate"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10076/stats/river-plate/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de River Plate...")
    stats_data = scrape_river_stats()
