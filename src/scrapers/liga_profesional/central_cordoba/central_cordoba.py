    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Central Cordoba', 'Central Cordoba', 'Liga Profesional'))
...
def scrap_plantel_centralcor():
    """Función principal para scrapear el plantel de centralcor"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de centralcor")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/213596/squad/central-cordoba-de-santiago")
