...
def scrape_ind_rivadavia_stats():
    """Scrapea las estadísticas de Independiente Rivadavia"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/161729/stats/independiente-rivadavia/teams")
    time.sleep(5)
        ...
        try:
            ...
            for row in rows:
                try:
                    ...
                    if team != "Independiente Rivadavia":
                        continue
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Independiente Rivadavia...")
    stats_data = scrape_ind_rivadavia_stats()
