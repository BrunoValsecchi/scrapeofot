    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Independiente Rivadavia', 'Independinte Rivadavia', 'Liga Profesional'))
...
def scrap_plantel_independienteriv():
    """Función principal para scrapear el plantel de independienteriv"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de independienteriv")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/161729/squad/independiente-rivadavia")
...
if __name__ == "__main__":
    scrap_plantel_independienteriv()
