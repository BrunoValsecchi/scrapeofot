...
def scrape_boca_stats():
    """Scrapea las estadísticas de Boca Juniors"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10077/stats/boca-juniors/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Boca Juniors...")
    stats_data = scrape_boca_stats()
