...
def scrape_huracan_stats():
    """Scrapea las estadísticas de huracan """
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10081/stats/huracan/teams")    
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de huracan ...")
    stats_data = scrape_huracan_stats()
