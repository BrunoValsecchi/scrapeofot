...
def scrape_newells_stats():
    """Scrapea las estadísticas de newells"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10201/stats/newells-old-boys/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Newells...")
    stats_data = scrape_newells_stats()
