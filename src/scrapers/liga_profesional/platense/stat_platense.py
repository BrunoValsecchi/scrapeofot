...
def scrape_platense_stats():
    """Scrapea las estadísticas de Platense"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10089/stats/club-atletico-platense/teams")
    time.sleep(5)
        ...
        try:
            ...
            for row in rows:
                try:
                    ...
                    if team != "Club Atletico Platense":
                        continue
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Platense...")
    stats_data = scrape_platense_stats()
