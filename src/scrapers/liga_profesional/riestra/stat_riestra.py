...
def scrape_riestra_stats():
    """Scrapea las estadísticas de Deportivo Riestra"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/298629/stats/deportivo-riestra/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Deportivo Riestra...")
    stats_data = scrape_riestra_stats()
