...
def scrape_lanus_stats():
    """Scrapea las estadísticas de lanus"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10082/stats/lanus/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Lanus...")
    stats_data = scrape_lanus_stats()
