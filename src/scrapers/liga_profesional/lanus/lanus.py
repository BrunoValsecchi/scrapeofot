...
def scrap_plantel_lanus():
    """Función principal para scrapear el plantel de lanus"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de lanus")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10082/squad/lanus")
