    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Sarmiento', 'Sarmiento', 'Liga Profesional'))
...
def scrap_plantel_sarmiento():
    """Función principal para scrapear el plantel de sarmiento"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de sarmiento")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/202757/squad/sarmiento")
