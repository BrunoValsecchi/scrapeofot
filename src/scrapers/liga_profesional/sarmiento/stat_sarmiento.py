...
def scrape_sarmiento_stats():
    """Scrapea las estadísticas de Sarmiento"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/202757/stats/sarmiento/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Sarmiento...")
    stats_data = scrape_sarmiento_stats()
