    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Talleres', 'Talleres', 'Liga Profesional'))
...
def scrap_plantel_talleres():
    """Función principal para scrapear el plantel de talleres"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de talleres")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10101/squad/talleres")
