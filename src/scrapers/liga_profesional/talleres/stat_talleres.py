...
def scrape_talleres_stats():
    """Scrapea las estadísticas de Talleres"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10101/stats/talleres/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Talleres...")
    stats_data = scrape_talleres_stats()
