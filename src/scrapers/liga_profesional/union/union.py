...
def scrap_plantel_union():
    """Función principal para scrapear el plantel de union"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de union")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10096/squad/union")
