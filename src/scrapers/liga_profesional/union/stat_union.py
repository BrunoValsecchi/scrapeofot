...
def scrape_union_stats():
    """Scrapea las estadísticas de union"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10096/stats/union/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Union...")
    stats_data = scrape_union_stats()
