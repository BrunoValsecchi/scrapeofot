    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Banfield', 'Banfield', 'Liga Profesional'))
...
def scrap_plantel_banfield():
    """Función principal para scrapear el plantel de banfield"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de banfield")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10087/squad/banfield")
