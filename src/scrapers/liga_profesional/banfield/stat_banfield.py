...
def scrape_banfield_stats():
    """Scrapea las estadísticas de Banfield"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10087/stats/banfield/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Banfield...")
    stats_data = scrape_banfield_stats()
