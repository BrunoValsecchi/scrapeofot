    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Godoy Cruz', 'Godoy Cruz', 'Liga Profesional'))
...
def scrap_plantel_godoy():
    """Función principal para scrapear el plantel de godoy"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de godoy")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10227/squad/godoy-cruz")
