...
def scrape_godoy_cruz_stats():
    """Scrapea las estadísticas de Godoy Cruz"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10227/stats/godoy-cruz/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Godoy Cruz...")
    stats_data = scrape_godoy_cruz_stats()
