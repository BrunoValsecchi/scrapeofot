    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Platense', 'Platense', 'Liga Profesional'))
...
def scrap_plantel_platense():
    """Función principal para scrapear el plantel de platense"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de platense")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10089/squad/club-atletico-platense")
