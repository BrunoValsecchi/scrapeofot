    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Defensa y Justicia', 'Defensa y Justicia', 'Liga Profesional'))
...
def scrap_plantel_defensa():
    """Función principal para scrapear el plantel de defensa"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de defensa")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/161730/squad/defensa-y-justicia")
