    ...
    try:
        cursor.execute("""
            ...
            SET nombre_corto = EXCLUDED.nombre_corto,
                liga = EXCLUDED.liga
            RETURNING equipo_id;
        """, ('Huracan', 'Huracan', 'Liga Profesional'))
...
def scrap_plantel_huracan():
    """Función principal para scrapear el plantel de huracan"""
    start_time = time.time()
    logging.info("Iniciando scraping de plantel de huracan")
    ...
    try:
        ...
        driver.get("https://www.fotmob.com/teams/10081/squad/huracan")
