...
def scrape_san_lorenzo_stats():
    """Scrapea las estadísticas de San Lorenzo"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10083/stats/san-lorenzo/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de San Lorenzo...")
    stats_data = scrape_san_lorenzo_stats()
