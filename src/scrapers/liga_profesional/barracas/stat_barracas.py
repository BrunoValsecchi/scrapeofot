...
def scrape_barracas_stats():
    """Scrapea las estadísticas de Barracas Central"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/213534/stats/barracas-central/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Barracas Central...")
    stats_data = scrape_barracas_stats()
