...
def scrape_racing_stats():
    """Scrapea las estadísticas de Racing Club"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/10080/stats/racing-club/teams  ")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Racing Club...")
    stats_data = scrape_racing_stats()
