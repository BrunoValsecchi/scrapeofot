...
def scrape_defensa_stats():
    """Scrapea las estadísticas de Defensa y Justicia"""
    driver = webdriver.Chrome(service=Service(ChromeDriverManager().install()), options=Options())
    driver.get("https://www.fotmob.com/teams/161730/stats/defensa-y-justicia/teams")
    time.sleep(5)
...
def main():
    ...
    print("🔍 Scrapeando estadísticas de Defensa y Justicia...")
    stats_data = scrape_defensa_stats()
